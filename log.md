...
**Today's Progress**: Did some training and read some articles.  Worked more on the Git tutorial, got it working (kind of) in Atom.


**Thoughts:** I think I was exhausted after all the coding over the long weekend.  Plus the Git stuff bogged me down a bit.  I like using Git in Atom, but I'm creating projects on git and cloning them locally.  I'm not sure I know how to create them locally and clone them to GitHub online.  I don't want to get bogged down in this stuff, but it's important.
