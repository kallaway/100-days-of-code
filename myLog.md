...
<h2>Day 69: July 31, 2018</h2>
<strong>Today's Progress**</strong>  So, I have been logging all of my progress on Twitter.  I have been terrible at updating my log here.  So, if you are interested in what I was doing in between day 19 and today, you can check out my Twitter feed.  https://twitter.com/Audrey_Lin_D  I have been super busy in this #100daysofCode challenge.  I messed up this log though... No biggie.  I will pick it up here.  I will start to log my projects in here now, too.  I've been learning sort of all over the place. However, for the rest of this challenge in Round1, I am going to do the #JavaScript30 challenge by WesBos.  I'll do a project per day & log it here in Github (I'll briefly mention it here, but also have a repo set aside for just #javascript30).  I'm going to learn how to use Github better for the rest of my 30 days & I plan to finish my FreeCodeCamp.org Responsive web design certificate this round.  If I have time, I will start the JavaScript Cert for Freecodecamp, but we will see if I can squeeze it in this round.  But I will definitely hit a round two.  My round two, I have some better organized plans.  This round is sort of a mess...productive, but a mess.  Lol.  Next round will be better logged & probably will include Hacktoberfest & a few Udemy certifications.  

<strong>Thoughts:**</strong> I'm learning that learning requires learning how to learn & how to improve your learning methods/routines/schedule/etc.  It isn't difficult, as long as you have a plan & stick to the plan as scheduled.  So, my new focus is to focus on learning & structuring my own lesson plans.  I have to build my portfolio & site.  I have a lot to add to my schedule for this.  However, I am very excited to be in the third trimester of this challenge. So, re-setting my focus to have a better learning structure for the rest of this round and the next.  

<h2>Day70: August 1, 2018</h2>
<strong>Today's Progress**</strong> Today I did some more of the #MERN course from @TraversyMedia on #Udemy.  It is a really good course.  I finished all except the profile all display & the comment postings sections.  I probably won't post it here yet, but I will use a lot of the techniques I learned in my site eventually.  I also started the #JAVASCRIPT30 challenge today by @WesBos I'll post that in another of my repos.  I forked his repo, but I'll create a new one.  

<strong> Thoughts:**</strong> I think I need a log of all the things I am learning and the details about each topic.  I think I will start to do that when I learn what I am doing...Lol.  I'm getting there.  I'm not really comfortable to write about it yet, but I will get there.  Maybe in the next round.  
