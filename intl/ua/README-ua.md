...
Додаткові ресурси нижче (посилання) будуть перекладені незабаром :)
* [Правила](rules.md)
...
1. Прочитайте статтю, з якої все почалося. Вона англійською, але, вона коротка та, в основному, написана простими реченнями: [Приєднуйся до #100DaysOfCode]
...
та я спробую допомогти. Можна й російською - я нею вільно володію :) ).
...
Додавайте свої щоденні оновлення у цей файл [Log (Щоденник)](log.md) або в його альтернативну версію зі спрощеним та прискоренним форматом: [(rapid) R1 Log](r1-log.md)
...
4. **Надихати і підтримувати, хоча б двох інших людей, які проходять #100DaysOfCode челлендж - кожен день у Твіттері! Це окупиться двічі - ви знайдете друзів зі спільними інтересами і допоможете комусь, хто міг здатися і закинути своє навчання програмуванню.**
...
* Якщо вам сподобався цей проект і ви вважаєте, що він може бути корисним іншим - будь ласка, поставте зірочку на Гітхабі (у правому верхньому кутку екрану) :)
